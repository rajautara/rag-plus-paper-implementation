...
def mathematics_example():
    ...
    knowledge_items = [
        ...
        KnowledgeItem(
            id="math_003",
            content="""Bayes' Theorem: Let A and B be two events, with P(B) > 0. Then the posterior probability of A given B is: P(A|B) = [P(B|A) × P(A)] / P(B)""",
            knowledge_type="procedural",
...
║                                                                              ║
║     Enhancing Retrieval-Augmented Generation with Application-Aware         ║
║                            Reasoning                                         ║
║                                                                              ║
║                    Based on the paper by Yu Wang et al.                      ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
    """)
